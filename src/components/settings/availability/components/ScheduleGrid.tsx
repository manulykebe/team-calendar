...
export function ScheduleGrid({ schedule, isAlternate = false, onTimeSlotToggle, disabled = false }: ScheduleGridProps) {
  return (
    <div className={`grid grid-cols-6 gap-4 ${disabled ? 'opacity-50' : ''}`}>
