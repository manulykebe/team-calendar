export const nl = {
  ...
  auth: {
    ...
    mustChangePassword: 'Wijzig uw wachtwoord',
    mustChangePasswordMessage: 'Om veiligheidsredenen moet u uw wachtwoord wijzigen voordat u verder gaat.',
    emailRequired: 'E-mail is verplicht',
    passwordRequired: 'Wachtwoord is verplicht',
    siteRequired: 'Site is verplicht',
  },
  ...
  reports: {
    ...
    availabilityReport: 'Beschikbaarheidsrapport',
    availabilityReportDescription: 'Team beschikbaarheidsschema\'s exporteren naar Excel',
    availabilityReportInstructions: 'Genereer een Excel-rapport met werkschema\'s en beschikbaarheid van alle teamleden.',
    aggregatedAvailability: 'Geaggregeerde Beschikbaarheid',
    aggregatedAvailabilityDescription: 'Niet-beschikbare teamleden per datum exporteren',
    aggregatedAvailabilityInstructions: 'Genereer een Excel-rapport met welke teamleden niet beschikbaar zijn per datum/periode.',
    unavailableUsers: 'Niet-beschikbare Gebruikers',
    aggregatedLeave: 'Geaggregeerd Verlof',
    aggregatedLeaveDescription: 'Teamleden met verlof per datum exporteren',
    aggregatedLeaveInstructions: 'Genereer een Excel-rapport met welke teamleden verlof hebben per datum/periode.',
    usersOnLeave: 'Gebruikers met verlof',
    period: 'Periode',
    date: 'Datum',
    total: 'Totaal',
