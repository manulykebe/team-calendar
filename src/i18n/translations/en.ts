export const en = {
  ...
  reports: {
    ...
    aggregatedLeave: 'Aggregated Leave',
    aggregatedLeaveDescription: 'Export team members on leave by date',
    aggregatedLeaveInstructions: 'Generate an Excel report showing which team members are on leave for each date/period.',
    usersOnLeave: 'Users on Leave',
    period: 'Period',
    date: 'Date',
    total: 'Total',
