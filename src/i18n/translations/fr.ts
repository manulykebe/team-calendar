export const fr = {
  ...
  reports: {
    ...
    aggregatedLeave: 'Congés Agrégés',
    aggregatedLeaveDescription: 'Exporter les membres d\'équipe en congé par date',
    aggregatedLeaveInstructions: 'Générez un rapport Excel affichant quels membres de l\'équipe sont en congé pour chaque date/période.',
    usersOnLeave: 'Utilisateurs en Congé',
    period: 'Période',
    date: 'Date',
    total: 'Total',
