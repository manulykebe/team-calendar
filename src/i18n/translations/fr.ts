export const fr = {
  ...
  calendar: {
    ...
    createHoliday: 'Cliquez pour créer des vacances pour la semaine {{week}} ({{startDate}} - {{endDate}})',
    deleteHoliday: 'Cliquez pour supprimer les vacances pour la semaine {{week}} ({{startDate}} - {{endDate}})',
    available: 'Disponible',
    unavailable: 'Indisponible',
    weekend: 'Week-end',
    holiday: 'Vacances',
    requestedHoliday: 'Vacances demandées',
    approvedHoliday: 'Vacances approuvées',
    deniedHoliday: 'Vacances refusées',
    pendingHoliday: 'Vacances en attente',
    requestedDesiderata: 'Desiderata demandés',
  ...
  events: {
    ...
    holidayRequestsOpen: 'Les demandes de vacances sont ouvertes ({{period}})',
    holidayDesiderataOpen: 'Les demandes de vacances et desiderata sont ouvertes ({{period}})',
    periodClosed: 'La période est fermée aux demandes ({{period}})',
    unknownStatus: 'Statut inconnu ({{period}})',
    noEventTypesAvailable: 'Aucun type d\'événement disponible',
    periodClosedMessage: 'Cette date est dans une période fermée. La création d\'événements n\'est pas autorisée.',
    cascadedSystem: 'Système en cascade : les demandes de vacances ont la priorité sur les desiderata',
  ...
  users: {
    ...
    cannotDeleteLastAdmin: 'Impossible de supprimer le dernier utilisateur administrateur',
  ...
  availability: {
    ...
    addScheduleBefore: 'Ajouter un horaire avant',
    addScheduleAfter: 'Ajouter un horaire après',
    splitSchedule: 'Diviser l\'horaire',
    deleteSchedule: 'Supprimer l\'horaire',
    extendPrecedingSchedule: 'Étendre l\'horaire précédent',
    extendFollowingSchedule: 'Étendre l\'horaire suivant',
    firstSchedule: 'Premier horaire',
    previousSchedule: 'Horaire précédent',
    nextSchedule: 'Horaire suivant',
    lastSchedule: 'Dernier horaire',
    newSchedule: 'Nouveau',
    addNewSchedule: 'Ajouter un nouvel horaire',
    splitDate: 'Date de division',
    endDateForCurrentSchedule: 'Date de fin pour l\'horaire actuel',
    newScheduleWillStart: 'Le nouvel horaire commencera le {{date}}',
    selectDateBetween: 'Sélectionnez une date entre {{start}} et {{end}} pour diviser l\'horaire.',
  ...
  export: {
    ...
    startDateOptional: 'Date de début (optionnelle)',
  ...
  subscription: {
    ...
    subscribeToYourCalendar: 'S\'abonner à votre calendrier',
    ...
    outlookInstructions: [
      ...
      'Cliquez avec le bouton droit sur Calendrier dans le volet de navigation',
      'Sélectionnez "Ajouter un calendrier" → "Depuis Internet"',
      'Collez l\'URL d\'abonnement',
      'Cliquez sur "OK" ou "Enregistrer"',
      'Choisissez la fréquence de synchronisation d\'Outlook avec le calendrier',
    ...
    googleInstructions: [
      ...
      'Sélectionnez "Depuis une URL" dans le menu déroulant',
    ...
    appleIosInstructions: [
      ...
      'Appuyez sur "Ajouter un compte" → "Autre" → "Ajouter un calendrier abonné"',
      'Collez l\'URL d\'abonnement',
    ...
    icalNote: 'Note : Le calendrier utilise le format iCalendar (.ics), qui est compatible avec la plupart des applications de calendrier modernes.',
  ...
  periods: {
    ...
    validationErrors: {
      ...
      overlappingDates: 'Les dates de la période se chevauchent avec une période existante',
  ...
  adminHoliday: {
    ...
    adminReview: 'Révision administrateur',
